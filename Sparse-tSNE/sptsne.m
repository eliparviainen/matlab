function X = sptsne(x, K, L, G, maxiter, verbose, tsneopt, sigma2)
%
...
% ------------------
  ...
  % lower tri
  A = sparse2(sprA,spcA,spvA+1,N,N);
  ...
  A = sparse2(sprA,spcA,spvAp1,N,N);
  ...
  % here: sp=sparse2([spr; spc], [spc; spr], [spv; spv], N, N);
