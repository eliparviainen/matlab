function X = sptsne_optimize_oldsparse(N, numL, numG, ...
                             ProwsUL, PcolsUL, PvalsUL, ...
                             ProwsUG, PcolsUG, PvalsUG, ...
                             opt, oldX)
  %  -----------------------------------------------------------
  %  This is a version of sptsne_optimize.m that uses original 
  ...
  for iter=1:opt.max_iter
    ...
    % MATLAB SPARSE
    LL = sparse(double(ProwsUL(:)), double(PcolsUL(:)), LvalsL(:), ...
                n, n, length(ProwsUL));  clear LvalsL
    LG = sparse(double(ProwsUG(:)), double(PcolsUG(:)), LvalsG(:), ...
                n, n, length(ProwsUG));  clear LvalsG
