function X = gsne(N, Lspr, Lspc, Lspv, gsneopt, verbose)
...
% 
  ...
  sp = sparse2([Lspr; Lspc; Lspd], [Lspc; Lspr; Lspd], Lspvv, N, N);
  ...
  if isfield(gsneopt,'lowmem') & gsneopt.lowmem
    ...
    mask = sparse2(Gspr, Gspc, 1:length(Gspr), N, N);
  ...
  %
  sp = sparse2([LGspr; LGspc], [LGspc; LGspr], [LGspv; LGspv]/2, N, N);
  ...
  X = sptsne_optimize(N, L, gsneopt.numG, ...
